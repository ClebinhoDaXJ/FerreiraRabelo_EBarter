...
class Good{
    ...
    public: 
        ...
        Good(World* mundo, string gname, vector<float> gqval, vector<float> gdval, vector<float> gnval, int initialQtd);
        ~Good();
        string _gname;
        unsigned index;
        int totalGood;
...
class World{ //reune todas as sociedades e bens existentes no mundo.
    public:
        ...
        */
        ...
        int n_g;
        int n_s;
        void gadd(string name, vector<float> gqval, vector<float> gdval, vector<float> gnval, int initialQtd=0); 
        void sadd(string sname, string cname, vector<float> sqval, vector<float> sdval, vector<float> snval, int qtd_moedas=0);
